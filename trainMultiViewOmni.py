...
if args.dataset == 'deep360':
  ...
  if args.mode == 'all' or args.mode == 'disp':
    ...
    trainFusionData = myDataset(rootDir='../../datasets/Deep360/',
                                interDir='../',
                                depthOriDir='../../datasets/omniFisheyeDataset/omnihouse/omnidepth_gt_640',
                                mode=args.mode,
                                curStage='training',
                                datasetName=args.dataset,
                                shape=(640,
                                ...
                                inputRGB=True,
                                needMask=False)
    valFusionData = myDataset(rootDir='../../datasets/Deep360/',
                              interDir='../',
                              depthOriDir='../../datasets/omniFisheyeDataset/omnihouse/omnidepth_gt_640',
                              mode=args.mode,
                              curStage='testing',
...
if args.mode == 'all' or args.mode == 'fusion' or args.mode == 'intermedia_fusion':
  ...
  if args.scheduler:
    ...
    scheduler_fusion = optim.lr_scheduler.MultiStepLR(optimizer=optimizer_fusion, milestones=[10, 30, 50], gamma=0.2)
  else:
